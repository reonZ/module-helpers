...
declare function createTradeMessage(origin: ActorPF2e, target: ActorPF2e, item: PhysicalItemPF2e, quantity: number, subtitle: string, message: string, userId?: string): Promise<ChatMessage | undefined>;
declare function createActionMessage(origin: ActorPF2e, cost: string | number | null | ActionCost, imgPath: string, subtitle: string, message: string, userId?: string): Promise<ChatMessage | undefined>;
type TradeData = {
    origin: ActorPF2e;
    target: ActorPF2e;
