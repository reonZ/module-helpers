...
declare function createCallOrEmit<TType extends string, TOptions extends Record<string, any>, TOptionsWithSocket = WithSocketOptions<TOptions>, TPacket = ExtractSocketOptions<TType, TOptions>>(packetType: TType, callback: (options: TOptions, userId: string) => void, socket?: {
    emit: (packet: TPacket) => void;
}): (options: TOptionsWithSocket, userId?: string) => void;
type ExtractSocketOptions<TType extends string, TOptions extends Record<string, any>> = ExtractSocketOptionsRequired<TOptions> & ExtractSocketOptionsPartial<TOptions> & {
    type: TType;
};
