...
declare function createFormData<E extends HTMLFormElement>(html: E, options?: FormData): Record<string, unknown>;
declare function createFormData<E extends HTMLElement | HTMLFormElement>(html: E, options?: FormData): Record<string, unknown> | null;
type FormData = {
    expand?: boolean;
    disabled?: boolean;
    readonly?: boolean;
