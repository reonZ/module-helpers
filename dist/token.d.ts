...
declare function getFirstActiveToken(actor: ActorPF2e, scene?: ScenePF2e): TokenDocumentPF2e<ScenePF2e | null> | null;
declare function getFirstTokenThatMatches(actor: ActorPF2e, predicate: (token: TokenDocumentPF2e) => boolean, scene?: ScenePF2e | undefined): TokenDocumentPF2e<ScenePF2e | null> | null;
