...
declare function objectIsIn<T extends Record<string, unknown>, O extends Record<string, unknown> = Record<string, unknown>, K extends string = string>(obj: Readonly<Record<PropertyKey, unknown>> | O, key: K): obj is NarrowedTo<O, Record<K, T>>;
